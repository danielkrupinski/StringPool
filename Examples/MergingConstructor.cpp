...
int main()
{
    ...
    const std::string_view s1 = pool1.add("first string");
    const std::string_view s2 = pool2.add("second string");
    const std::string_view s3 = pool3.add("third string");
    const std::string_view s4 = pool4.add("fourth string");
